...
if(isset($_POST['submit']))
{
  ...
  $sql="update animal set AnimalName=:aname,Breed=:breed,Description=:adetails,AnimalCategory=:animalcategory,Status=:animalstatus,LastUpdate=:lastupdate where ID=:aid";
  $query = $dbh->prepare($sql);
  $query->bindParam(':aname',$aname,PDO::PARAM_STR);
  $query->bindParam(':breed',$breed,PDO::PARAM_STR);
  $query->bindParam(':animalstatus',$animalstatus,PDO::PARAM_STR);
  $query->bindParam(':animalcategory',$animalcategory,PDO::PARAM_STR);
  $query->bindParam(':adetails',$adetails,PDO::PARAM_STR);
  $query->bindParam(':lastupdate',$lastupdate,PDO::PARAM_STR);
                    ...
                    <form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <div class="">
                            ...
                            <select class="form-control"   name="animalcategory"  id="animalcategory"  required>
                              <option value="<?php echo htmlentities($result->AnimalCategory);?>"><?php echo htmlentities($result->AnimalCategory);?></option>
                      ...
                      <div class="row">
                        <div class="form-group col-md-6">
                          <label for="focusedinput" class=" control-label">Upadate animal status</label>
                          <div class="">
                            <select class="form-control"   name="animalstatus"  id="animalstatus"  required>
