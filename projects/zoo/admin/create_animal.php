...
if(isset($_POST['submit']))
{
  ...
  $sql="INSERT INTO animal(AnimalName,CageNumber,FeedNumber,Breed,Description,AnimalImage,AnimalCategory,Dateofbirth) VALUES(:aname,:cage,:feed,:breed,:adetails,:aimage,:animalcategory,:dob)";
  ...
  $query->bindParam(':animalcategory',$animalcategory,PDO::PARAM_STR);
                ...
                <div class="card-body">
                  ...
                  <form class="form-sample"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-4">
                        <label class="col-sm-12 pl-0 pr-0">Animal Date Of Birth(<span style="color: blue;">optional</span>)</label>
                        <div class="col-sm-12 pl-0 pr-0">
                          <input type="date" class="form-control" name="dob" id="dob" placeholder="Date">
                        </div>
                      </div>
                      <div class="form-group col-md-4 pl-md-0">
                         <label class="col-sm-12 pl-0 pr-0">Animal Category</label>
                    ...
                    <div class="row">
                      <div class="form-group col-md-6 ">
                        ...
                        <div class="col-sm-12 pl-0 pr-0">
                          <input type="number" class="form-control" name="cage" id="cage" placeholder=" Cage Number" required>
                        </div>
                      </div>
                    ...
                    <button type="submit" name="submit" class="btn-success btn">Create</button>
