...
<head>
  ...
  <title>Admin -  Dead Animals</title>
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      <?php $sql = "SELECT * from animal where Status='Dead' order by ID desc";
                      ...
                      if($query->rowCount() > 0)
                      {
                        ...
                        { 
                          ...
                          <tr>
                            ...
                            <td><a href="dead_animals.php?pid=<?php echo htmlentities($result->ID);?>"><button type="button" class="btn btn-sm btn-primary">View</button></a></td>
                          </tr>
                          <?php 
                          $cnt=$cnt+1; 
                        } 
