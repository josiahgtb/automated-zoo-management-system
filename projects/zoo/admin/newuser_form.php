...
if(!empty($_POST["fullname"])) {
  ...
  $sql ="SELECT UserName FROM admin WHERE UserName=:fullname";
  ...
  if($query -> rowCount() > 0)
  {
    ...
    { 
        ...
        $sql="INSERT INTO  admin(Staffid,AdminName,UserName,FirstName,LastName,Email,MobileNumber,Password) VALUES(:staffid,:dignity,:fname,:firstname,:lastname,:email,:mobile,:password)";
        $query = $dbh->prepare($sql);
