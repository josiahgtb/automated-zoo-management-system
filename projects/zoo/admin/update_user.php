...
if(isset($_POST['saveupdates']))
{
  ...
  $mobno2=$_POST['phone2'];
  $email2=$_POST['email2'];
  $sql4="update admin set FirstName=:firstname2,LastName=:lastname2,MobileNumber=:mobilenumber2,Email=:email2 where ID=:aid";
...
<div class="card-body">
  ...
  <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
    <?php
    $eid=$_POST['edit_id'];
    $sql="SELECT * from  admin where tbladmin.ID=:eid";
