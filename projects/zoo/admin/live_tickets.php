    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Online Booked Tickets</h1>
            <ol class="breadcrumb">
                ...
                <div class="modal-dialog modal-md">
                  <div class="modal-content">
                    ...
                    <div class="modal-body" id="info_update5">
                      <?php @include("view_onlineticket.php");?>
                    </div>
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      <?php $sql = "SELECT  * from billing where Status='on' order by ID desc";
                        ...
                        foreach($results as $result)
                          {       ?>    
                            <tr>
                              ...
                              <td>
                                <a href="#"  class="edit_data5" id="<?php echo  ($result->TicketID); ?>"  title="click to view"><button type="button" class="btn btn-sm btn-primary">Invoice</button></a>
                                <a href="#"   class=" edit_data3" id="<?php echo  ($result->ID); ?>"   title="click to Update"><button type="button" class="btn btn-sm btn-success">View</button></a>
                                <a href="#"   class=" edit_data4" id="<?php echo  ($result->ID); ?>"   title="click to Update"><button type="button" class="btn btn-sm btn-success">Update</button></a></td>
                              </tr>
                              <?php $cnt=$cnt+1;
                            } 
                          }?>
      ...
      <div id="editData4" class="modal fade">
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">Update Ticket details</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
